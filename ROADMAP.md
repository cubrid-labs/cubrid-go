...
- 📋 [GitHub Milestones](https://github.com/cubrid-labs/cubrid-go/milestones)
...
## Next Release — v1.0.0 — Stable Release

- API freeze and stability guarantees
- Full protocol coverage for all CUBRID data types
- Connection pooling optimization
- Context support across all operations
- Performance parity with MySQL drivers

## Compatibility

Go 1.21+, CUBRID 10.2–11.4
